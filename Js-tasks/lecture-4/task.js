...
const languages = (array) => {
  let newLanguagesString = "";
  if (array.length > 4) {
    let firstFourLanguages = array.slice(0, 4);
    firstFourLanguages = firstFourLanguages.join(", ");
    newLanguagesString = `${firstFourLanguages} и другие языки программирования`;
  } else {
    newLanguagesString = array.join(", ");
  }
